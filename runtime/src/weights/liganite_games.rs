...
impl<T: frame_system::Config> liganite_games::WeightInfo for WeightInfo<T> {
	...
	fn game_add(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(15_089_358, 0)
			.saturating_add(Weight::from_parts(0, 3765))
			// Standard Error: 2_739
			.saturating_add(Weight::from_parts(14_434, 0).saturating_mul(a.into()))
			// Standard Error: 16_993
			.saturating_add(Weight::from_parts(3_978_265, 0).saturating_mul(b.into()))

...
impl<T: frame_system::Config> liganite_publish::WeightInfo for WeightInfo<T> {
	...
	fn publisher_add(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(7_590_068, 0)
			.saturating_add(Weight::from_parts(0, 3765))
			// Standard Error: 174
			.saturating_add(Weight::from_parts(137, 0).saturating_mul(a.into()))
			// Standard Error: 172
			.saturating_add(Weight::from_parts(1_022, 0).saturating_mul(b.into()))
